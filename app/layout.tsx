...
export const metadata = {
  title: 'Agent',
  description: 'Talk about the Agent',
  icons: '/gts-logo.png', // <-- here
};
...
export default async function RootLayout({ children }: RootLayoutProps) {
  ...
  const { accent, accentDark, pageDescription } = await getAppConfig(origin);
  ...
  return (
    <html lang="en" suppressHydrationWarning className="scroll-smooth">
      <head>
        ...
        <meta name="description" content="Demo Agent" />
        <ApplyThemeScript />
      </head>
      <body
